...
import { MapPin, AlertCircle, CheckCircle, ArrowUpRight, Search } from "lucide-react";
...
export function ConstituencyMap({ pins, title = "Constituency Works Geo-Verification" }: ConstituencyMapProps) {
  const [selectedPin, setSelectedPin] = useState<ConstituencyPin | null>(pins[0] || null);
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 pb-4">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400">
            Work-level location pins colored by ML anomaly score across villages and wards.
          </p>
        </div>
      ...
      <div className="mt-5 grid grid-cols-1 lg:grid-cols-12 gap-5">
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] text-slate-500">({p.village})</span>
                  </div>
        ...
        <div className="lg:col-span-5 rounded-xl border border-slate-800 bg-slate-950/80 p-4.5 flex flex-col justify-between">
          {selectedPin ? (
            <div className="space-y-3.5">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between rounded-lg bg-slate-900/60 p-2">
                  ...
                  <span className="font-medium text-slate-200">{selectedPin.village}, {selectedPin.constituency}</span>
                </div>
                <div className="flex justify-between rounded-lg bg-slate-900/60 p-2">
            ...
            <p className="text-xs text-slate-500">Select a work pin to inspect</p>
          )}
